...
def editmembers():
    ...
    # Let's put a label just under the title
    #
    member_label = Label(root, text = "Members Table Editing", fg="red", font=("Helvetica", 18))
    ...
    # Record Frame for editing/adding boats
    #
    record_frame = LabelFrame(root, text="Membership Record")
    record_frame.pack(fill="x", expand="yes", padx=20)
...
edit_menu.add_command(label="Member Data", command=editmembers)
